        ...
        <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #e5e7eb', padding: 28 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' as const, gap: 18 }}>
            ...
            <button onClick={save} disabled={submitting}
              style={{ background: submitting ? '#6b7280' : 'var(--brand)', color: '#fff', border: 'none', borderRadius: 10, padding: 12, fontSize: 15, fontWeight: 600, cursor: submitting ? 'wait' : 'pointer', marginTop: 4 }}>
